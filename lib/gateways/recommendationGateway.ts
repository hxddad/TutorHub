...
// FR11 (recommendations), NFR7 (interoperability), NFR8 (graceful failure), NFR15 (SRP)

const BASE_URL = process.env.RECOMMENDATION_SERVICE_URL ?? "http://localhost:8000";

// FR11 - fetch tutor recommendations for a given student from the Python service
