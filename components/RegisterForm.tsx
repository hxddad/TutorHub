...
export default function RegisterForm() {
  ...
  const handleSubmit = useCallback(
    (e: React.FormEvent) => {
      ...
      setSuccessMessage("Account created successfully! (Demo – no data saved)");
      setFullName("");
      setEmail("");
      setPassword("");
      setConfirmPassword("");
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <button
          ...
          className="inline-flex items-center justify-center gap-2.5 rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-medium text-slate-700 shadow-sm hover:bg-emerald-50 hover:border-emerald-200 hover:text-emerald-800 transition-colors"
        >
