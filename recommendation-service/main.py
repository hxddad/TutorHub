...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://tutor-hub-gold.vercel.app", "http://localhost:3000", "http://localhost:3001", "http://localhost:3002"],
...
def get_db_connection():
    try:
        conn = psycopg2.connect(os.getenv("PRISMA_DATABASE_URL"))
        return conn
